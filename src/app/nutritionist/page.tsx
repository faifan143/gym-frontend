...
import { Dumbbell, Map, Menu, PersonStandingIcon, X } from "lucide-react";
import { useEffect, useState } from "react";

const NutritionSidebar = ({ activeTab, setActiveTab, tabs, isMobile }) => {
...
const NutritionHeader = ({ activeTab, tabs }) => {
  return (
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className={`flex-1 ${isMobile ? "p-0" : "pl-64"}`} dir="rtl">
        <NutritionHeader activeTab={activeTab} tabs={tabs} />
